...
- Variaveis recomendadas:
  ...
  - `OPENAI_FTE_RAG_TIMEOUT_MS` (opcional, default `28000`; orçamento do agente RAG)
  - `OPENAI_FTE_RAG_RETRY_TIMEOUT_MS` (opcional, default `36000`; retry adicional do RAG)
  - `OPENAI_FTE_RAG_CNAE_LIMIT` (opcional, default `6`; CNAEs priorizados no RAG)
  - `OPENAI_FTE_RAG_MAX_OUTPUT_TOKENS` (opcional, default `2600`; limite de saída do RAG)
  - `OPENAI_FTE_RAG_TEMPERATURE` (opcional, default `0`; modo determinístico)
  - `ENV_COMPLIANCE_RAG_STABILITY_REUSE_DAYS` (opcional, default `120`; reaproveita último RAG válido quando a execução atual falhar)
