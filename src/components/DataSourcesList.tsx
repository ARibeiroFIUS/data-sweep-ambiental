...
function reasonLabel(reason?: string) {
  ...
  const map: Record<string, string> = {
    ...
    access_blocked: "Acesso bloqueado pelo portal.",
    captcha_blocked: "Bloqueado por captcha/validação humana.",
    no_automatable_form: "Portal sem formulário automatizável.",
    portal_disabled: "Consulta pública desativada no portal.",
    http_error: "Erro HTTP na fonte consultada.",
    not_found: "Fonte consultada sem registros.",
